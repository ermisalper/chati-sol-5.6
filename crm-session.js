(function(global){
  ...
  global.CombinvestCRM={customerId:customerId,storageKey:storageKey,load:load,data:data,save:save,url:url,propagateLinks:propagateLinks,ready:(global.Combinvest&&global.Combinvest.ready)||Promise.resolve()};
